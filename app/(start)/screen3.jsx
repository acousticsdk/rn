    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <Animated.View style={animatedImageStyle}>
          <Image
            source={{ uri: 'https://alfacta.online/100k/screen3.png' }}
        ...
        <View style={styles.content}>
          <Text style={styles.title}>
            <Text style={styles.titleWhite}>Миллионы просмотров </Text>
          </Text>
          ...
          <Text style={styles.subtitle}>
            Мы запускаем контент, который{'\n'}приносит реальные деньги
          </Text>

          <View style={styles.buttonContainer}>
            <Button title="НАЧАТЬ" onPress={handleStart} variant="rounded" />
          </View>
        </View>
      </View>
    </SafeAreaView>
